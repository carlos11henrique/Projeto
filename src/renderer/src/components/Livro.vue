 ...
 <table class="w-full text-[16px] text-gray-700 dark:text-gray-300 table-auto">
  <thead class="text-base uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
    <tr>
      ...
      <!-- Coluna Título com quebra -->
      <th class="px-6 py-4 max-w-[200px] whitespace-normal break-words">Título</th>
      
      <!-- Coluna Autor com quebra -->
      <th class="px-6 py-4 max-w-[180px] whitespace-normal break-words">Autor</th>
  ...
  <tbody>
    ...
    >
      ...
      <!-- Células com quebra de texto -->
      <td class="px-6 py-4 max-w-[200px] whitespace-normal break-words">{{ livro.titulo }}</td>
      <td class="px-6 py-4 max-w-[180px] whitespace-normal break-words">{{ livro.autor }}</td>

      <td class="px-6 py-4 max-w-[180px] whitespace-normal break-words">{{ livro.Category?.dataValues?.nome || '-' }}</td>
