<template>
  <div class="flex flex-col h-screen bg-gray-100">
    ...
    <div class="flex flex-1">
      ...
      <!-- Main Content -->
      <main class="flex-1 p-4 mt-16 sm:ml-64 transition-all duration-300" :class="{'sm:ml-64': sidebarOpen}">
...
#sidebar {
  ...
  z-index: 30; /* Para garantir que a sidebar fique acima do conteúdo */
}
</style>
